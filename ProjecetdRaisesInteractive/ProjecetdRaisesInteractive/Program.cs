...
namespace ProjecetdRaisesInteractive
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("What is emplopyee 1's salary this year >>>");
            employeeSalary1 = Convert.ToDouble(Console.ReadLine());


            Console.WriteLine("What is emplopyee 2's salary this year >>>");
            employeeSalary2 = Convert.ToDouble(Console.ReadLine());


            Console.WriteLine("What is emplopyee 3's salary this year >>>");
